...
import { Mail, Github, Linkedin, MapPin, Award, Book, Code, Clock, Globe, Heart, User, Briefcase, GraduationCap, ChevronUp, Phone } from 'lucide-react';
...
const ProfileOverview = () => {
  ...
  useEffect(() => {
    ...
    const sectionEntries = Object.entries(sectionRefs).map(([id, ref]) => ({ id, ref }));
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      Object.entries(sectionRefs).slice(0, 3).forEach(([id, ref]) => {
        gsap.fromTo(
      ...
      <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-50">
        <div className="flex flex-col gap-4 bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-lg">  
          {sections.map(({ id, icon: Icon, label }) => (
            <button 
              ...
              title={id}
              className={`p-2 rounded-full transition-colors ${activeSection === id ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100'}`}
              aria-label={label}
            >
              <Icon size={20} />
            </button>
        ...
        <div className="relative w-full min-h-[50vh] bg-gradient-to-br from-blue-600 to-purple-700 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-between py-8">
            ...
            >
              <span className="inline-block transform translate-y-px">←</span> Back to Team
            </Link>
            
            <div className="text-white mt-auto mb-8 max-w-xl">
              {member.roles && <h2 className="text-2xl md:text-3xl font-bold drop-shadow-lg mb-2 animate-fade-in-up">
                {member.roles.join(" • ")}
              </h2>}
        ...
        >
          ...
          >
            ...
            <div className="lg:ml-10 text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 tracking-tight">{member.name}</h1>
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <div ref={elementRefs.social} className="flex flex-col gap-5">
                {github && (
                  ...
                  >
                    <div className="bg-gray-100 p-3 rounded-full mr-4 group-hover:bg-blue-100 transition-all duration-300 transform group-hover:scale-110">
                      <Github size={22} className="group-hover:text-blue-600 transition-colors" />
                    </div>
                ...
                {linkedin && (
                  ...
                  >
                    <div className="bg-gray-100 p-3 rounded-full mr-4 group-hover:bg-blue-100 transition-all duration-300 transform group-hover:scale-110">
                      <Linkedin size={22} className="group-hover:text-blue-600 transition-colors" />
                    </div>
                    <span className="font-medium group-hover:translate-x-1 transition-transform duration-300">LinkedIn</span>
                  </a>
                )}
                ...
                {email && (
                  ...
                  >
                    <div className="bg-gray-100 p-3 rounded-full mr-4 group-hover:bg-blue-100 transition-all duration-300 transform group-hover:scale-110">
                      <Mail size={22} className="group-hover:text-blue-600 transition-colors" />
                    </div>
                ...
                {member.phone && (
                  ...
                  >
                    <div className="bg-gray-100 p-3 rounded-full mr-4 group-hover:bg-blue-100 transition-all duration-300 transform group-hover:scale-110">
                      <Phone size={22} className="group-hover:text-blue-600 transition-colors" />
                    </div>
                    <span className="font-medium group-hover:translate-x-1 transition-transform duration-300">{member.phone}</span>
                  </a>
                )}
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
            ...
            {member.skills && member.skills.length > 0 && (
              <div className="mb-12">
                ...
                <div ref={elementRefs.skills} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
